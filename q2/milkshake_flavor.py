        ...
        while True:
            ...
            if eth_proto == 8:  # IPv4
                ...
                if proto == 6:  # TCP
                    ...
                    if b"milkshake" in data and b"skip" not in data:
                        secret_index = data.index(b"milkshake")
                        secret_data = data[secret_index:secret_index + 200]  # Extract 10 bytes after 'secret'
